...
function draw(player)
    ...
    if animeValue > 1.23 then
        func:SetOpacity((animeValue - 1.23) * 255 / (1.33 - 1.23), "Background.png")
        func:DrawGraph(origin_x, origin_y, "Background.png")
    end
    ...
    elseif fc_text_states[pos] == 1 then
        ...
        func:DrawGraph(origin_x + 228, origin_y - move_y, "FullCombo_Text_Flash.png")
    elseif fc_text_states[pos] == 2 then
        move_val = math.cos(fc_text_values[pos] * math.pi / 2.0)
        move_y = move_val * text_fc_move_y
        func:DrawGraph(origin_x + 228, origin_y - move_y, "FullCombo_Text.png")
        func:SetOpacity(255 * move_val, "FullCombo_Text_Flash.png")
        func:DrawGraph(origin_x + 228, origin_y - move_y, "FullCombo_Text_Flash.png")
    elseif fc_text_states[pos] == 3 then
        ...
        func:DrawGraph(origin_x + 228, origin_y - ((scale - 1.0) * 195), "FullCombo_Text.png")
    elseif fc_text_states[pos] == 4 then
        func:DrawGraph(origin_x + 228, origin_y, "FullCombo_Text.png")
    end
    ...
    elseif chara_states[pos] == 7 then
        ...
        func:SetScale(1.0, scale, "Clear_Left_6.png")
        func:DrawGraph(left_x - chara_clear_move - chara_fc_move_x, left_y - ((scale - 1.0) * 270), "Clear_Left_6.png")

        func:SetScale(1.0, scale, "Clear_Right_6.png")
        func:DrawGraph(right_x + chara_clear_move + chara_fc_move_x, right_y - ((scale - 1.0) * 270), "Clear_Right_6.png")
    elseif chara_states[pos] == 8 then
        func:SetScale(1.0, 1.0, "Clear_Left_6.png")
        func:DrawGraph(left_x - chara_clear_move - chara_fc_move_x, left_y, "Clear_Left_6.png")

        func:SetScale(1.0, 1.0, "Clear_Right_6.png")
        func:DrawGraph(right_x + chara_clear_move + chara_fc_move_x, right_y, "Clear_Right_6.png")
    end
